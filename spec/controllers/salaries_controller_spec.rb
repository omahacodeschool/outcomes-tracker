  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created salary" do
        post :create, {:salary => valid_attributes}, valid_session
        expect(response).to redirect_to(Salary.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved salary as @salary" do
        post :create, {:salary => invalid_attributes}, valid_session
        expect(assigns(:salary)).to be_a_new(Salary)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested salary" do
        salary = Salary.create! valid_attributes
        put :update, {:id => salary.to_param, :salary => new_attributes}, valid_session
        salary.reload
      ...
      it "redirects to the salary" do
        salary = Salary.create! valid_attributes
        put :update, {:id => salary.to_param, :salary => valid_attributes}, valid_session
        expect(response).to redirect_to(salary)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the salary as @salary" do
        salary = Salary.create! valid_attributes
        put :update, {:id => salary.to_param, :salary => invalid_attributes}, valid_session
        expect(assigns(:salary)).to eq(salary)
      end
