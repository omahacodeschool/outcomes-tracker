class EntriesController < ApplicationController
  ...
  private
    ...
    def entry_params
      # binding.pry
      params.require(:entry).permit(:user_id, :company, job_application_attributes: [ :location, :job_title, :posting_url, :company_contact, :notes ], offer_attributes: [:job_title, :location, :reote])
      #fix typo
      # binding.pry
    end
